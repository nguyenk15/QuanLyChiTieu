...
{
    public partial class TraNo : UserControl
    {
        private DataClasses1DataContext trano = new DataClasses1DataContext();
        public TraNo()
        {
            InitializeComponent();
        }
        ...
        private void refresh()
        {
            ...
            var list = from a in trano.Tranos
                       where a.ID == a.ID
                       select a;
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("Xin vui lòng nhập người cho vay");
                }
            }
            catch (Exception ex)
            {
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            try
            {
                var xoa = trano.Tranos.Single(a => a.ID.ToString() == dataGridView1.CurrentRow.Cells["ID"].Value.ToString());
                trano.Tranos.DeleteOnSubmit(xoa);
                trano.SubmitChanges();
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            try
            {
                Chovay b = trano.Chovays.Single(a => dataGridView1.CurrentRow.Cells["ID"].Value.ToString() == a.ID.ToString());
                ...
                b.Người_Vay = dataGridView1.CurrentRow.Cells["Người_Cho_Vay"].Value.ToString();
